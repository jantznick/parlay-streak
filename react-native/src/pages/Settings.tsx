        ...
        <View className="px-6">
          ...
          <View className="mb-8">
            <ScrollView 
              ...
              className="bg-white dark:bg-transparent rounded-2xl border border-slate-200 dark:border-transparent"
            >
              ...
              {visibleStreaks < MOCK_STREAK_HISTORY.length && (
                <TouchableOpacity
                  ...
                  className="bg-slate-100 dark:bg-slate-800/50 py-3 rounded-xl items-center border border-slate-200 dark:border-slate-700/50 mt-2 mb-2 mx-2"
                >
                  <Text className="text-slate-600 dark:text-slate-400 font-semibold">Load More</Text>
                </TouchableOpacity>
              )}
            </ScrollView>
          </View>
          ...
          {user.isAdmin && (
            <>
              ...
              <TouchableOpacity
                ...
                className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 px-4 py-4 flex-row items-center justify-between mb-8 shadow-sm dark:shadow-none"
              >
                <View className="flex-row items-center gap-3">
                  ...
                  <View>
                    ...
                    <Text className="text-slate-500 dark:text-slate-400 text-xs">Manage games & users</Text>
                  </View>
                </View>
          ...
          >
            ...
            <Text className="text-red-600 dark:text-red-400 text-base font-semibold">Sign Out</Text>
          </TouchableOpacity>
