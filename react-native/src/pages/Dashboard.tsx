      ...
      >
        ...
        <View className="px-6 pt-4 pb-6">
          {user && (
            <View>
              {/* Primary streak card */}
              <View className="bg-primary rounded-[24px] px-6 py-6 mb-5 shadow-lg shadow-primary/20">
                <Text className="text-sm font-medium text-primary-foreground/90 mb-1">
                  Current Streak
                </Text>
                <View className="flex-row items-end justify-between">
                  <View>
                    <Text className="text-6xl font-black text-primary-foreground leading-tight">
                      {user.currentStreak}
                    </Text>
                    <Text className="text-sm text-primary-foreground/80 font-medium">
        ...
        <View className="px-6 pb-6">
          ...
          {loading && !refreshing ? (
            <View className="py-8 items-center">
              ...
              <Text className="text-muted-foreground text-xs mt-3">Loading available bets...</Text>
            </View>
          ) : error ? (
            ...
            <View className="gap-4">
              {games.map((game) => {
                ...
                return (
                  <View
                    key={game.id}
                    className="bg-slate-900 rounded-[20px] border border-slate-800 overflow-hidden shadow-sm"
                  >
                    {/* Game Header */}
